// MARK: - Mocks generated from file: QuickMediaSearch/Scene/MyStore/MyStorePresenter.swift at 2020-02-09 07:44:22 +0000
...
@testable import QuickMediaSearch
 ...
 class MockMyStorePresentationLogic: MyStorePresentationLogic, Cuckoo.ProtocolMock {
     ...
     typealias MocksType = MyStorePresentationLogic
    
     typealias Stubbing = __StubbingProxy_MyStorePresentationLogic
     typealias Verification = __VerificationProxy_MyStorePresentationLogic

     let cuckoo_manager = Cuckoo.MockManager.preconfiguredManager ?? Cuckoo.MockManager(hasParent: false)

    
    private var __defaultImplStub: MyStorePresentationLogic?

     func enableDefaultImplementation(_ stub: MyStorePresentationLogic) {
    ...
    return cuckoo_manager.call("presentFetchedFavorites()",
	 ...
	 struct __StubbingProxy_MyStorePresentationLogic: Cuckoo.StubbingProxy {
	    ...
	    func presentProgress<M1: Cuckoo.Matchable>(isShow: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(Bool)> where M1.MatchedType == Bool {
	        ...
	        return .init(stub: cuckoo_manager.createStub(for: MockMyStorePresentationLogic.self, method: "presentProgress(isShow: Bool)", parameterMatchers: matchers))
	    }
	 ...
	 struct __VerificationProxy_MyStorePresentationLogic: Cuckoo.VerificationProxy {
	    private let cuckoo_manager: Cuckoo.MockManager
 ...
 class MyStorePresentationLogicStub: MyStorePresentationLogic {
...
// MARK: - Mocks generated from file: QuickMediaSearch/Scene/SearchList/SearchListPresenter.swift at 2020-02-09 07:44:22 +0000
...
// MARK: - Mocks generated from file: QuickMediaSearch/Service/KakaoService.swift at 2020-02-09 07:44:22 +0000
...
import Foundation
 ...
 class MockKakaoServiceType: KakaoServiceType, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call("fetchImage(urlRequest: URLRequest, result: @escaping (Result<KakaoImageResponse, Error>) -> Void)",
            parameters: (urlRequest, result),
            escapingParameters: (urlRequest, result),
            superclassCall:
                
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.fetchImage(urlRequest: urlRequest, result: result))
    ...
    return cuckoo_manager.call("fetchVClip(urlRequest: URLRequest, result: @escaping (Result<KakaoVclipResponse, Error>) -> Void)",
            parameters: (urlRequest, result),
            escapingParameters: (urlRequest, result),
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.fetchVClip(urlRequest: urlRequest, result: result))
	 ...
	 struct __StubbingProxy_KakaoServiceType: Cuckoo.StubbingProxy {
	    ...
	    func fetchImage<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(urlRequest: M1, result: M2) -> Cuckoo.ProtocolStubNoReturnFunction<(URLRequest, (Result<KakaoImageResponse, Error>) -> Void)> where M1.MatchedType == URLRequest, M2.MatchedType == (Result<KakaoImageResponse, Error>) -> Void {
	        let matchers: [Cuckoo.ParameterMatcher<(URLRequest, (Result<KakaoImageResponse, Error>) -> Void)>] = [wrap(matchable: urlRequest) { $0.0 }, wrap(matchable: result) { $0.1 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockKakaoServiceType.self, method: "fetchImage(urlRequest: URLRequest, result: @escaping (Result<KakaoImageResponse, Error>) -> Void)", parameterMatchers: matchers))
	    }
	    
	    func fetchVClip<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(urlRequest: M1, result: M2) -> Cuckoo.ProtocolStubNoReturnFunction<(URLRequest, (Result<KakaoVclipResponse, Error>) -> Void)> where M1.MatchedType == URLRequest, M2.MatchedType == (Result<KakaoVclipResponse, Error>) -> Void {
	        let matchers: [Cuckoo.ParameterMatcher<(URLRequest, (Result<KakaoVclipResponse, Error>) -> Void)>] = [wrap(matchable: urlRequest) { $0.0 }, wrap(matchable: result) { $0.1 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockKakaoServiceType.self, method: "fetchVClip(urlRequest: URLRequest, result: @escaping (Result<KakaoVclipResponse, Error>) -> Void)", parameterMatchers: matchers))
	    }
	 ...
	 struct __VerificationProxy_KakaoServiceType: Cuckoo.VerificationProxy {
	    ...
	    @discardableResult
	    func fetchImage<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(urlRequest: M1, result: M2) -> Cuckoo.__DoNotUse<(URLRequest, (Result<KakaoImageResponse, Error>) -> Void), Void> where M1.MatchedType == URLRequest, M2.MatchedType == (Result<KakaoImageResponse, Error>) -> Void {
	        let matchers: [Cuckoo.ParameterMatcher<(URLRequest, (Result<KakaoImageResponse, Error>) -> Void)>] = [wrap(matchable: urlRequest) { $0.0 }, wrap(matchable: result) { $0.1 }]
	        return cuckoo_manager.verify("fetchImage(urlRequest: URLRequest, result: @escaping (Result<KakaoImageResponse, Error>) -> Void)", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
	    
	    @discardableResult
	    func fetchVClip<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(urlRequest: M1, result: M2) -> Cuckoo.__DoNotUse<(URLRequest, (Result<KakaoVclipResponse, Error>) -> Void), Void> where M1.MatchedType == URLRequest, M2.MatchedType == (Result<KakaoVclipResponse, Error>) -> Void {
	        let matchers: [Cuckoo.ParameterMatcher<(URLRequest, (Result<KakaoVclipResponse, Error>) -> Void)>] = [wrap(matchable: urlRequest) { $0.0 }, wrap(matchable: result) { $0.1 }]
	        return cuckoo_manager.verify("fetchVClip(urlRequest: URLRequest, result: @escaping (Result<KakaoVclipResponse, Error>) -> Void)", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
...
// MARK: - Mocks generated from file: QuickMediaSearch/Service/KakaoUsecase.swift at 2020-02-09 07:44:22 +0000
...
import Foundation
 ...
 class MockKakaoUsecaseType: KakaoUsecaseType, Cuckoo.ProtocolMock {
    
     typealias MocksType = KakaoUsecaseType
    
     typealias Stubbing = __StubbingProxy_KakaoUsecaseType
     typealias Verification = __VerificationProxy_KakaoUsecaseType

     let cuckoo_manager = Cuckoo.MockManager.preconfiguredManager ?? Cuckoo.MockManager(hasParent: false)

    
    private var __defaultImplStub: KakaoUsecaseType?

     func enableDefaultImplementation(_ stub: KakaoUsecaseType) {
        __defaultImplStub = stub
        cuckoo_manager.enableDefaultStubImplementation()
    }
    ...
    return cuckoo_manager.call("fetchMedium(result: @escaping (Result<[Thumbnailable], Error>) -> Void)",
	 ...
	 struct __StubbingProxy_KakaoUsecaseType: Cuckoo.StubbingProxy {
	    private let cuckoo_manager: Cuckoo.MockManager
	    ...
	    func fetchMedium<M1: Cuckoo.Matchable>(result: M1) -> Cuckoo.ProtocolStubNoReturnFunction<((Result<[Thumbnailable], Error>) -> Void)> where M1.MatchedType == (Result<[Thumbnailable], Error>) -> Void {
	        ...
	        return .init(stub: cuckoo_manager.createStub(for: MockKakaoUsecaseType.self, method: "fetchMedium(result: @escaping (Result<[Thumbnailable], Error>) -> Void)", parameterMatchers: matchers))
	    }
	    
	}

	 struct __VerificationProxy_KakaoUsecaseType: Cuckoo.VerificationProxy {
	    private let cuckoo_manager: Cuckoo.MockManager
	    private let callMatcher: Cuckoo.CallMatcher
	    private let sourceLocation: Cuckoo.SourceLocation
 ...
 class KakaoUsecaseTypeStub: KakaoUsecaseType {
